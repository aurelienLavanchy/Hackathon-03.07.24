    ...
    <>
      ...
      <form className="container-form" onSubmit={handleSubmit(onSubmit)}>
        <div className="container-image">
          <img
            className="img-offer"
            src="../../assets/images/sign-953533_640.jpg"
            alt="offer"
          />
        </div>
        <div className="form-offer">
          ...
          <textarea
            ...
            {...register("description", {
              ...
              minLength: {
                value: 2,
                message: "La description doit contenir au minimun 2 caractères",
              },
            })}
          />
          {errors.description && (
            <span className="error-offer">{errors.description.message}</span>
          )}
